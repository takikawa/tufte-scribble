...
% Override legend to work nicely with tufte
\renewcommand{\Legend}[1]{\caption{#1}}

% figure** is turned into marginfigure
\renewenvironment{FigureMultiWide}{\begin{marginfigure}\FigureSetRef}{\end{marginfigure}}
